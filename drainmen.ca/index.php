...
<head>
    ...
    <link rel="stylesheet" href="css/drainmen.css">
    <link rel="icon" type="image/png" href="resources/images/drainmen-logo.png?" />
        ...
        <header id="header" class="alt">
            <div class="row">
                <div class="col-sm-6 col-xs-12">
                    <span class="logo desktop"><img src="resources/images/drainmen-logo.png" alt="Paint Men, Let's Paint!" /></span>
                    <p class="slogan"> We'll keep you dry </p>
                </div>
                <div class="col-sm-6 col-xs-12">
                    <div class="row">
                        <div class="col-xs-12">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <a href="tel:7784005475" class="skel-layers-ignoreHref callLink"><i id="callIcon1" class="fa fa-phone fa-2x fa-inverse"></i>778 400 5475</A>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12">
                            <a href="tel:6047579739" class="skel-layers-ignoreHref callLink"><span><i id="callIcon2" class="fa fa-phone fa-2x"></i></span>604 757 9739</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <nav id="nav">
            <div class="desktop">
                <div class="navLogoContainer">
                    <a class="logo" href="#header"><img src="resources/images/drainmen-logo.png" height="52" alt="Paint Men, Let's Paint!" /></a>
                </div>
                ...
                <div class="navLinkContainer">
                    <a href="tel:18883834242" class="skel-layers-ignoreHref"><span class="icon fa fa-phone">1 855 590 1977</span></a>
                </div>
            </div>
        </nav>
       <nav id="navMobile">
    ...
    <!-- Footer -->
        <footer id="footer">
            <div class="textContainer">
                ...
                <p> Copyright &copy; 2016 Drain Men Canada Incorporated</p>
